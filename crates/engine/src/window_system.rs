...
impl EngineState {
    ...
    pub fn register_window(&self, title: String, window_type: WindowType) -> usize {
        ...
        println!(
            "📋 Registered window #{}: {:?}",
            id,
            state.windows.get(&id).unwrap().window_type
        );
        id
    }
    ...
    thread::Builder::new()
        ...
        .spawn(move || {
            ...
            struct WindowHandler {
                ...
                build_view:
                    Option<Box<dyn FnOnce(&mut Window, &mut App, EngineState) -> AnyView + Send>>,
            }
            ...
            impl ApplicationHandler for WindowHandler {
                fn resumed(&mut self, event_loop: &ActiveEventLoop) {
                    ...
                    let gpui_window = app
                        .open_window_external(external_handle, move |window, cx| {
            ...
            let build_view_boxed: Box<
                dyn FnOnce(&mut Window, &mut App, EngineState) -> AnyView + Send,
