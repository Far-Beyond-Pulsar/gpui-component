...
use std::rc::Rc;
use std::ops::Range;
use crate::ui::windows::editor::tabs::daw_editor::audio_types::SAMPLE_RATE;
...
fn render_track_row(
    track: &crate::ui::windows::editor::tabs::daw_editor::audio_types::Track,
    state: &DawUiState,
    total_width: f32,
    cx: &mut Context<DawPanel>,
) -> impl IntoElement {
                                    ...
                                    this.update(cx, |this, cx| {
                                        ...
                                        if let Some(project) = &mut this.state.project {
                                            if let Some(track) = project.tracks.iter_mut().find(|t| t.id == track_id_val) {
                                                ...
                                                let clip = crate::ui::windows::editor::tabs::daw_editor::audio_types::AudioClip::new(
...
fn render_clip(
    clip: &crate::ui::windows::editor::tabs::daw_editor::audio_types::AudioClip,
    track_id: uuid::Uuid,
    state: &DawUiState,
    cx: &mut Context<DawPanel>,
) -> impl IntoElement {
