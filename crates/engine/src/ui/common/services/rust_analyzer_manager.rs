...
pub enum AnalyzerEvent {
    ...
    Ready,
    Error(String),
    Diagnostics(Vec<crate::ui::windows::editor::drawers::problems_drawer::Diagnostic>),
}
                                        ...
                                        if let (Some(range), Some(message)) = (
                                            ...
                                            if let (Some(start), Some(severity_num)) = (
                                                ...
                                                let severity = match severity_num {
                                                    1 => crate::ui::windows::editor::drawers::problems_drawer::DiagnosticSeverity::Error,
                                                    2 => crate::ui::windows::editor::drawers::problems_drawer::DiagnosticSeverity::Warning,
                                                    3 => crate::ui::windows::editor::drawers::problems_drawer::DiagnosticSeverity::Information,
                                                    4 => crate::ui::windows::editor::drawers::problems_drawer::DiagnosticSeverity::Hint,
                                                    _ => crate::ui::windows::editor::drawers::problems_drawer::DiagnosticSeverity::Information,
                                                };
                                                
                                                let file_path = uri.trim_start_matches("file:///").replace("%20", " ");
                                                
                                                diagnostics.push(crate::ui::windows::editor::drawers::problems_drawer::Diagnostic {
                                                    file_path,
                                                    line,
                                                    column,
                                                    severity,
