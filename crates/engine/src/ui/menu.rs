...
actions!(
    ...
    [
        // App menu
        AboutApp, CheckUpdates, Preferences, Settings,
        Hide, HideOthers, ShowAll, QuitApp,
        // File menu
        NewFile, NewWindow, NewProject, NewScene, NewScript, NewShader, NewMaterial, NewPrefab,
        NewBlueprint, NewComponent, NewSystem,
        OpenFile, OpenFolder, OpenRecent, OpenRecentFiles, ClearRecent,
        SaveFile, SaveAs, SaveAll, SaveWorkspace,
        ImportAsset, ImportModel, ImportTexture, ImportAudio, BatchImport,
        ImportFromUnity, ImportFromUnreal, ImportFromGodot,
        ExportBuild, ExportScene, ExportSelected,
        ExportWindows, ExportLinux, ExportMacOS, ExportWeb, ExportAndroid, ExportIOS,
        RevertFile, CloseFile, CloseFolder, CloseAll, CloseOthers,
        // Edit menu
        Undo, Redo, Cut, Copy, Paste, Delete,
        SelectAll, SelectNone,
        Find, FindNext, FindPrevious, FindReplace, ReplaceNext, ReplaceAll,
        FindInFiles, ReplaceInFiles, FindUsages, FindImplementations,
        FormatDocument, FormatSelection,
        CommentLine, UncommentLine, ToggleComment,
        Fold, Unfold, FoldAll, UnfoldAll,
        SortLines, RemoveDuplicates, TrimWhitespace,
        // Selection menu
        SelectLine, SelectWord, SelectScope,
        ExpandSelection, ShrinkSelection,
        AddCursorAbove, AddCursorBelow, AddCursorLineEnds,
        SelectAllOccurrences, SelectNextOccurrence, SkipOccurrence,
        // View menu
        ToggleExplorer, ToggleHierarchy, ToggleInspector, ToggleAssetBrowser,
        ToggleConsole, ToggleTerminal, ToggleOutput, ToggleProblems, ToggleDebug,
        ToggleProfiler, ToggleMemoryAnalyzer, ToggleNetwork,
        SplitHorizontal, SplitVertical,
        SingleColumn, TwoColumns, ThreeColumns,
        ResetLayout, SaveLayout,
        CommandPalette, QuickOpen,
        ZoomIn, ZoomOut, ResetZoom,
        ToggleMinimap, ToggleLineNumbers, ToggleBreadcrumbs, ToggleWhitespace,
        ToggleFullscreen, ToggleZenMode,
        // Go menu
        GoToFile, GoToSymbol, GoToLine,
        GoToDefinition, GoToTypeDefinition, GoToImplementation, GoToReferences,
        GoBack, GoForward, GoToLastEdit,
        NextProblem, PreviousProblem,
        // Project menu
        ProjectSettings, BuildSettings, PackageSettings,
        AddDependency, UpdateDependencies, RemoveUnusedDeps, OpenCargoToml,
        GenerateDocs, RunCargoCheck, RunClippy, FormatProject,
        // Build menu
        Build, BuildAndRun, BuildRelease, Rebuild, Clean,
        BuildDebug, BuildReleaseDebug, BuildProfile,
        CancelBuild, ShowBuildOutput,
        // Run menu
        RunProject, RunWithoutDebug, StopExecution, RestartExecution,
        DebugProject, StartDebug, StopDebug, RestartDebug,
        StepOver, StepInto, StepOut, Continue,
        ToggleBreakpoint, DisableBreakpoints, RemoveBreakpoints,
        RunTests, RunFailedTests, RunFileTests, DebugTest, RunCoverage,
        RunBenchmarks, CompareBenchmarks, ProfileBuild,
        // Engine menu (using unique names)
        OpenScene, SaveScene, SaveSceneAs,
        PlayScene, PauseScene, StopScene, SceneSettings,
        CreateEmpty,
        CreateCube, CreateSphere, CreateCapsule, CreateCylinder, CreatePlane, CreateTerrain,
        CreateSprite, CreateTilemap, CreateParticles2D,
        CreateDirectionalLight, CreatePointLight, CreateSpotLight, CreateAreaLight,
        CreateAudioSource, CreateAudioListener,
        CreateParticleSystem, CreateVFX, CreatePostProcessing,
        CreateCamera, CreateOrthoCamera,
        CreateCanvas, CreatePanel, CreateButton, CreateText, CreateImage, CreateSlider, CreateInputField,
        AddRigidbody, AddCollider, AddCharacterController,
        PhysicsSettings, CollisionMatrix,
        RenderSettings, LightingSettings, QualitySettings,
        BakeLighting, ClearBakedData,
        FrameDebugger, EngineProfiler,
        PackageManager, AssetStore,
        // Assets menu
        CreateAsset,
        CreateMaterial, CreateShader, CreateTexture,
        CreateAnimClip, CreateAnimController,
        CreateAudioMixer, CreateRenderTexture,
        CreatePrefab, CreateScriptableObject,
        RefreshAssets, ReimportAssets, ReimportAllAssets,
        FindAssetReferences, FindMissingReferences,
        // Tools menu
        CargoCommands, GenerateRustAnalyzer,
        ExpandMacro, ShowSyntaxTree, ShowHIR,
        InlineVariable, ExtractFunction, ExtractVariable,
        ShaderEditor, CompileShader, ShaderVariants, SPIRVDisassembly,
        AnimationWindow, AnimatorWindow, Timeline,
        MaterialEditor, TerrainTools, ParticleEditor, AudioMixerWindow,
        VersionControl, TaskManager, Extensions,
        // Window menu
        Minimize, Zoom, BringAllToFront, CloseWindow,
        // Help menu
        ShowDocumentation, ShowAPIReference, ShowTutorials,
        ShowShortcuts, ReportIssue, ViewLogs, ReleaseNotes
    ]
);
