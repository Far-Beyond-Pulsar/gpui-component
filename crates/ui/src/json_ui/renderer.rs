...
impl UiRenderer {
    ...
    fn render_unknown(component: &UiComponent, props: &HashMap<String, UiValue>, cx: &mut Context<crate::json_ui::JsonCanvas>) -> impl IntoElement {
        let mut element = div()
            .border_1()
